...
// Ícone SVG do WhatsApp para o botão flutuante
const WhatsAppIconFloating = ({ size = 28 }: { size?: number }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="currentColor" 
    width={size}
...
const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full text-[#264788] group-hover:bg-white group-hover:text-[#24902C] transition-colors duration-300">
        <WhatsAppIconFloating size={28} />
      </div>

      <div className="hidden sm:flex flex-col items-start leading-none">
        <span className="text-[11px] font-semibold opacity-80 mb-0.5 uppercase tracking-wide">
          Precisa de ajuda?
        </span>
